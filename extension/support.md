---
layout: bare
title: IPA Reader Extension - Support
---

# IPA Reader Extension - Support
...
A: IPA Reader Extension is designed for Google Chrome and Chromium-based browsers (Edge, Brave, etc.).

### IPA & Annotations

**Q: How do I enable IPA annotations?**  
A: Click the IPA Reader icon in your browser toolbar, then toggle "Enable IPA" on. You can also click the floating button on the bottom-right of any page to toggle whole-page IPA mode.

**Q: Can I switch between American and British pronunciation?**  
A: Yes. Open the extension popup and change "IPA Style" to switch between "American English" and "British English". Both IPA annotations and TTS pronunciation will follow the selected accent.

**Q: What are the color-coded IPA symbols?**  
A: In whole-page IPA mode, phonetic symbols are color-coded by type: vowels in blue, consonants in gray, stress marks in red, and length marks in purple. This makes it easier to read and understand the phonetic structure.

**Q: What are weak/strong forms?**  
A: Many common English function words (like "the", "to", "can") have two pronunciations — a reduced weak form used in natural speech and a full strong form used for emphasis. When "Show weak/strong forms" is enabled, hovering over these words shows both variants.
...
A: Please check your system volume. TTS quality depends on your operating system's English voice support. On some systems, you may need to install an English voice pack.
...
A: The ~ symbol indicates the IPA was generated by rule-based conversion (G2P). The ≈ symbol indicates it was derived from a related base word through lemmatization. These may be slightly less accurate than dictionary entries.
