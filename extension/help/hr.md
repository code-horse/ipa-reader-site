...
### Korak 3: Odaberite text ili koristite plutajući gumb

Odaberite engleski text koji želite označiti, ili kliknite plutajući gumb u donjem desnom kutu da omogućite IPA na cijeloj stranici.

### Korak 4: Prikaz IPA

Prijeđite mišem preko riječi da vidite IPA tooltipove, kliknite ikonu zvučnika da čujete izgovor.
...
**Metoda 1: Plutajući gumb**  
Odaberite engleski text mišem, gumb zvučnika pojavljuje se u gornjem desnom kutu odabira — kliknite za govor.

**Metoda 2: Kontekstni izbornik**  
Nakon odabira engleskog teksta, desnim klikom odaberite "Speak Selection" iz izbornika.

> **Savjet:** Govor odabira koristi brzinu govora rečenica postavljenu u vašim postavkama. Izgovor pojedinačnih riječi koristi zadanu brzinu. TTS glas odgovara vašem odabranom tipu naglaska (američki ili britanski).
