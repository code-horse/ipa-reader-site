...
- **Slovník při najetí** — Najeďte na slova a uvidíte anglické definice (82 000+ slov z WordNetu), IPA s barevně kódovanými symboly a tlačítka výslovnosti; zvolte režim Slovník, Tooltip, Pouze mluvení nebo Vypnuto
...
| **Pouze mluvení** | Kliknutím na slovo uslyšíte výslovnost (bez tooltipu) |
...
- **Vyhledávání** — Hledání textu v PDF včetně vyhledávání pinyin → znaky u čínských PDF
...
| **Režim najetí** | Chování při najetí: Slovník (IPA + definice + zvuk), Tooltip (IPA + zvuk), Pouze mluvení (kliknutím přehrát), Vypnuto |
