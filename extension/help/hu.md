...
### 3. lépés: IPA engedélyezése

Kattintson a bővítmény ikonjára a böngésző eszköztárán. Kapcsolja be az „IPA engedélyezése” opciót, majd a „Teljes oldal IPA” opciót az összes szó megjegyzéséhez az oldalon. A jobb alsó sarokban lévő lebegő gombot is használhatja.

### 4. lépés: IPA megtekintése

Vigye az egeret a szavak fölé a színkódolt fonetikus szimbólumokat tartalmazó IPA tooltipek megtekintéséhez. Kattintson a hangszóró ikonra a kiejtés meghallgatásához. Gyenge/erős alakok esetén a tooltip mindkét változatot mutatja.

### 5. lépés: Kijelölt szöveg felolvasása és fordítása

Jelöljön ki bármilyen angol szöveget az egérrel. Megjelenik egy kompakt eszköztár a kijelölés közelében két gombbal:
- **🔊 Beszéd** — Felolvassa a kijelölt szöveget karaoke stílusú, szóról szóra kiemeléssel
- **🌐 Fordítás** — Beágyazott fordítási buborékot jelenít meg az eszköztár alatt
...
## Teljes oldal IPA mód

Ha a teljes oldal IPA mód be van kapcsolva, minden angol szóhoz az oldalon ruby szöveggel jelenik meg az IPA megjegyzés a szó fölött. Az IPA szimbólumok színkódoltak a könnyű olvasás érdekében:

- **Magánhangzók** — kék kiemeléssel
- **Mássalhangzók** — szürke színnel
- **Hangsúlyjelek** (ˈ ˌ) — piros kiemeléssel
...
Sok gyakori angol funkciószónak két kiejtése van:

- **Gyenge alak** — a természetes összefüggő beszédben használt redukált kiejtés (pl. „the” → /ðə/)
- **Erős alak** — a teljes kiejtés hangsúlyozáskor vagy izoláltan (pl. „the” → /ðiː/)

Ha a „Gyenge/erős alakok megjelenítése” be van kapcsolva, ezeknél a szavaknál a tooltip mindkét változatot mutatja „WEAK” és „STRONG” címkével. Ez segít megérteni, hogyan változik a kiejtés a természetes beszédben.

Érintett szavak többek között: névelők (the, a, an), elöljárószavak (to, for, of, from, at, as, than), kötőszavak (and, or, but), névmások (you, your, her, him, his, them, us, our, there), segédigék (am, is, are, was, were, been, can, could, would, should, must, shall, will, do, does, have, has, had) és továbbiak.

---

## Kijelölés beszéd és karaoke

A kijelölés beszéd funkció lehetővé teszi bármilyen angol szöveg kijelölését és egy kattintással felolvasását — ideális mondatkiejtés és olvasási gyakorlat tanulásához.

**1. módszer: Kijelölés eszköztár**  
Jelöljön ki angol szöveget az egérrel. Megjelenik egy kompakt eszköztár a kijelölés közelében 🔊 beszéd és 🌐 fordítás gombokkal. Kattintson a beszéd gombra a lejátszáshoz. A felolvasás közben minden szó valós időben kiemelődik (karaoke effekt), könnyebb követni.

**2. módszer: Jobb kattintás menü**  
Angol szöveg kijelölése után jobb klikk, majd válassza az „IPA Reader > Speak Selection” lehetőséget.

**3. módszer: Billentyűparancs**  
Jelöljön ki szöveget, majd nyomja meg az `Alt+Shift+S` (Mac: `Ctrl+Shift+S`) billentyűkombinációt a beszédhez.

> **Tipp:** A karaoke kiemelés akkor működik legjobban, ha a böngésző támogatja a TTS szóhatár eseményeket. Ha nem, a bővítmény időzítés alapú tartalék megoldást használ sima kiemeléshez.

---

## Fordítás

Jelöljön ki bármilyen szöveget az oldalon, és használja a fordítás funkciót azonnali fordításokhoz.

**1. módszer: Kijelölés eszköztár**  
Jelöljön ki szöveget, majd kattintson az eszköztár 🌐 fordítás gombjára. Megjelenik egy fordítási buborék az eredménnyel és másolás gombbal.

**2. módszer: Jobb kattintás menü**  
Jelöljön ki szöveget, jobb klikk, majd válassza az „IPA Reader > Translate Selection” lehetőséget.

**3. módszer: Billentyűparancs**  
Jelöljön ki szöveget, majd nyomja meg az `Alt+Shift+T` (Mac: `Ctrl+Shift+T`) kombinációt a fordításhoz.
...
| Parancs | Mac parancs | Művelet |
|----------|-------------|--------|
| `Alt+Shift+I` | `Ctrl+Shift+I` | IPA megjegyzések be/ki |
| `Alt+Shift+S` | `Ctrl+Shift+S` | Kijelölt szöveg felolvasása |
| `Alt+Shift+T` | `Ctrl+Shift+T` | Kijelölt szöveg fordítása |

> **Tipp:** Ezeket a Chrome-ban a `chrome://extensions/shortcuts` címen testreszabhatja.
