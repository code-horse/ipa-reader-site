---
layout: bare
title: IPA Reader Eklentisi - Kullanıcı Kılavuzu
lang: tr
---
...
**IPA Reader**'ı [Chrome Web Store](https://chromewebstore.google.com/)'dan yükleyin veya geliştirici modunda yerel olarak yükleyin.

### Adım 2: Herhangi Bir Web Sayfası Açın

İngilizce içerik içeren herhangi bir web sayfasını ziyaret edin.

### Adım 3: IPA'yı Etkinleştirin

Tarayıcı araç çubuğundaki eklenti simgesine tıklayın. „IPA'yı Etkinleştir”i açın, ardından sayfadaki tüm kelimeleri açıklamak için „Tüm Sayfa IPA”yı açın. Sağ alttaki yüzen düğmeyi de kullanabilirsiniz.

### Adım 4: IPA'yı Görüntüleyin

Kelimelerin üzerine gelerek renk kodlu fonetik sembollü IPA ipuçlarını görün. Telaffuzu duymak için hoparlör simgesine tıklayın. Zayıf/güçlü formlu kelimeler için ipucunda her iki varyant da gösterilir.

### Adım 5: Seçili Metni Seslendirin ve Çevirin

Fareyle herhangi bir İngilizce metni seçin. Seçimin yakınında iki düğmeli kompakt bir araç çubuğu görünür:
- **🔊 Konuş** — Seçimi karaoke tarzı kelime kelime vurgulama ile okur
- **🌐 Çevir** — Araç çubuğunun altında satır içi bir çeviri balonu gösterir
...
Tüm sayfa IPA modu etkinken, sayfadaki her İngilizce kelimenin üzerinde ruby metni olarak bir IPA açıklaması görünür. IPA sembolleri okumayı kolaylaştırmak için renk kodludur:

- **Ünlüler** — mavi vurgulu
- **Ünsüzler** — gri
- **Vurgu işaretleri** (ˈ ˌ) — kırmızı vurgulu
...
Birçok yaygın işlev sözcüğünün iki telaffuzu vardır:

- **Zayıf form** — doğal bağlı konuşmada kullanılan indirgenmiş telaffuz (örn. „the” → /ðə/)
- **Güçlü form** — vurgu veya yalın kullanımda tam telaffuz (örn. „the” → /ðiː/)

„Zayıf/güçlü formları göster” etkinken, bu kelimelerin üzerine gelindiğinde ipucunda „WEAK” ve „STRONG” etiketli her iki varyant da görünür. Doğal konuşmada telaffuzun nasıl değiştiğini anlamanıza yardımcı olur.

Kapsananlar arasında: tanımlayıcılar (the, a, an), edatlar (to, for, of, from, at, as, than), bağlaçlar (and, or, but), zamirler (you, your, her, him, his, them, us, our, there), yardımcı fiiller (am, is, are, was, were, been, can, could, would, should, must, shall, will, do, does, have, has, had) ve daha fazlası.

---

## Seçim Konuşması ve Karaoke

Seçim konuşması, herhangi bir İngilizce metni seçip tek tıklamayla sesli okumanızı sağlar — cümle telaffuzu ve okuma pratiği için idealdir.

**Yöntem 1: Seçim araç çubuğu**  
Fareyle İngilizce metni seçin. Seçimin yakınında 🔊 konuş ve 🌐 çeviri düğmeleri olan kompakt bir araç çubuğu belirir. Oynatmak için konuş düğmesine tıklayın. Metin okunurken her kelime gerçek zamanlı vurgulanır (karaoke etkisi).

**Yöntem 2: Sağ tık menüsü**  
İngilizce metni seçtikten sonra sağ tıklayıp „IPA Reader > Speak Selection” seçin.

**Yöntem 3: Klavye kısayolu**  
Metni seçin ve seslendirmek için `Alt+Shift+S` (Mac: `Ctrl+Shift+S`) tuşlarına basın.

> **İpucu:** Karaoke vurgulama, tarayıcınız TTS kelime sınırı olaylarını destekliyorsa en iyi çalışır. Desteklenmiyorsa eklenti akıcı vurgulama için zamanlamaya dayalı bir yedek kullanır.
...
**Yöntem 1: Seçim araç çubuğu**  
Metni seçin, araç çubuğundaki 🌐 çevir düğmesine tıklayın. Sonucun altında kopyalama düğmesi olan bir çeviri balonu görünür.

**Yöntem 2: Sağ tık menüsü**  
Metni seçin, sağ tıklayıp „IPA Reader > Translate Selection” seçin.

**Yöntem 3: Klavye kısayolu**  
Metni seçin ve çevirmek için `Alt+Shift+T` (Mac: `Ctrl+Shift+T`) tuşlarına basın.
...
> **İpucu:** Kısayolları Chrome'da `chrome://extensions/shortcuts` adresinden özelleştirebilirsiniz.
...
**S: Tüm sayfa modu düzeni etkiliyor mu?**  
C: IPA açıklamaları ekstra alan gerektirir. Eklenti satır yüksekliğini ayarlayarak etkiyi azaltır. Okumayı etkiliyorsa tüm sayfa modunu kapatın ve üzerine gelme ipuçlarını kullanın.

**S: İpuçlarındaki ~ ve ≈ sembolleri ne anlama geliyor?**  
C: ~ IPA'nın sözlük yerine kurallarla (G2P) üretildiğini, ≈ ise ilgili bir temel sözcükten türetildiğini gösterir. Sözlük girdilerinden daha az doğru olabilirler.
