...
Pilih teks bahasa Inggris yang ingin Anda anotasi, atau klik tombol mengambang di kanan bawah untuk mengaktifkan mode IPA seluruh halaman.

### Langkah 4: Lihat IPA

Arahkan kursor ke kata untuk melihat tooltip IPA, klik ikon speaker untuk mendengar pengucapan.
...
Fitur ucapan pilihan memungkinkan Anda memilih teks bahasa Inggris apa pun dan membacanya dengan lantang dengan satu klik — sempurna untuk mempelajari pengucapan kalimat dan latihan membaca.

**Metode 1: Tombol Mengambang**  
Pilih teks bahasa Inggris dengan mouse Anda, tombol speaker muncul di kanan atas pilihan — klik untuk mengucapkan.

**Metode 2: Menu Klik Kanan**  
Setelah memilih teks bahasa Inggris, klik kanan dan pilih "Speak Selection" dari menu.

> **Tip:** Ucapan pilihan menggunakan kecepatan bicara kalimat yang dikonfigurasi dalam pengaturan Anda. Pengucapan satu kata menggunakan kecepatan default. Suara TTS sesuai dengan jenis aksen yang Anda pilih (Amerika atau Inggris).
...
|------------|------------|
| **Enable IPA** | Saklar utama untuk mengaktifkan atau menonaktifkan fitur anotasi IPA |
