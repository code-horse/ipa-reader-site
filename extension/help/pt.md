...
Selecione o texto em inglês que deseja anotar, ou clique no botão flutuante no canto inferior direito para ativar o modo IPA em toda a página.

### Passo 4: Ver o IPA

Passe o rato sobre as palavras para ver os tooltips IPA, clique no ícone do altifalante para ouvir a pronúncia.
...
A funcionalidade de fala de seleção permite-lhe selecionar qualquer texto em inglês e lê-lo em voz alta com um clique — ideal para aprender pronúncia de frases e prática de leitura.

**Método 1: Botão Flutuante**  
Selecione texto em inglês com o rato, surge um botão de altifalante no canto superior direito da seleção — clique para falar.

**Método 2: Menu de Clique Direito**  
Após selecionar texto em inglês, clique com o botão direito e escolha "Speak Selection" no menu.

> **Dica:** A fala de seleção utiliza a velocidade de frase configurada nas definições. A pronúncia de palavra única usa a velocidade predefinida. A voz TTS corresponde ao tipo de sotaque selecionado (americano ou britânico).
