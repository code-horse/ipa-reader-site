---
layout: bare
title: IPA Reader - Uporabniški priročnik
lang: sl
---
...
Namestite **IPA Reader** iz [Chrome Web Store](https://chromewebstore.google.com/) ali ga naložite lokalno v razvijalskem načinu.

### 2. korak: Odprite poljubno spletno stran

Obiščite spletno stran z angleško vsebino.

### 3. korak: Omogočite IPA

Kliknite ikono razširitve v orodni vrstici brskalnika. Vklopite »Omogoči IPA«, nato »IPA celotne strani« za označitev vseh besed na strani. Lahko kliknete tudi lebdeči gumb v spodnjem desnem kotu.

### 4. korak: Oglejte si IPA

Premaknite miško nad besede za ogled IPA namigov z barvno kodiranimi fonetičnimi simboli. Kliknite ikono zvočnika za poslušanje izgovorjave. Pri besedah s šibkimi/močnimi oblikami namig prikaže obe različici.

### 5. korak: Preberite in prevedite izbrano besedilo

Izberite poljubno angleško besedilo z miško. Pri izbiri se prikaže kompaktna orodna vrstica z dvema gumboma:
- **🔊 Govor** — Izbrano besedilo prebere na glas z označevanjem besedo za besedo v slogu karaoke
- **🌐 Prevajaj** — Pod orodno vrstico prikaže vgradni prevajalski mehurček
...
Ko je omogočen način IPA celotne strani, dobi vsaka angleška beseda na strani IPA oznako nad seboj z ruby besedilom. IPA simboli so barvno kodirani za enostavno branje:

- **Samoglasniki** — označeni z modro
- **Soglasniki** — prikazani v sivi
- **Poudarki** (ˈ ˌ) — označeni z rdečo
...
Mnoge običajne angleške funkcijske besede imajo dve izgovorjavi:

- **Šibka oblika** — zmanjšana izgovorjava v naravnem povezanem govoru (npr. „the“ → /ðə/)
- **Močna oblika** — polna izgovorjava za poudarek ali v izolaciji (npr. „the“ → /ðiː/)

Ko je omogočeno »Prikaži šibke/močne oblike«, ob lebdenju nad temi besedami namig prikaže obe različici z oznakama »WEAK« in »STRONG«. Tako razumete, kako se izgovorjava spreminja v naravnem govoru.

Zajete besede vključujejo: členke (the, a, an), predloge (to, for, of, from, at, as, than), veznike (and, or, but), zaimke (you, your, her, him, his, them, us, our, there), pomožne glagole (am, is, are, was, were, been, can, could, would, should, must, shall, will, do, does, have, has, had) in druge.

---

## Branje izbire in karaoke

Funkcija branja izbire vam omogoča izbiro poljubnega angleškega besedila in branje na glas z enim klikom — idealno za učenje izgovorjave stavkov in bralno vadbo.

**Metoda 1: Orodna vrstica izbire**  
Izberite angleško besedilo z miško. Pri izbiri se prikaže kompaktna orodna vrstica z gumbom 🔊 za govor in gumbom 🌐 za prevod. Kliknite gumb za govor za predvajanje. Med branjem na glas se vsaka beseda v realnem času označi (karaoke učinek), kar pomaga pri sledenju.

**Metoda 2: Meni desnega klika**  
Po izbiri angleškega besedila z desnim klikom izberite »IPA Reader > Speak Selection«.

**Metoda 3: Bližnjica na tipkovnici**  
Izberite besedilo in pritisnite `Alt+Shift+S` (Mac: `Ctrl+Shift+S`) za govor.

> **Namig:** Karaoke označevanje najbolje deluje, če brskalnik podpira TTS dogodke mej besed. Če niso podprti, razširitev uporabi nadomestno rešitev na podlagi časovnih zamikov za gladko označevanje.
...
**Metoda 1: Orodna vrstica izbire**  
Izberite besedilo, nato kliknite gumb 🌐 za prevod na orodni vrstici. Pod orodno vrstico se prikaže prevajalski mehurček z rezultatom in gumbom za kopiranje.

**Metoda 2: Meni desnega klika**  
Izberite besedilo, z desnim klikom izberite »IPA Reader > Translate Selection«.
...
| Bližnjica | Bližnjica na Macu | Dejanje |
|----------|-------------|--------|
| `Alt+Shift+I` | `Ctrl+Shift+I` | Vklop/izklop IPA oznak |
| `Alt+Shift+S` | `Ctrl+Shift+S` | Govor izbranega besedila |
| `Alt+Shift+T` | `Ctrl+Shift+T` | Prevajanje izbranega besedila |

> **Namig:** Te bližnjice lahko prilagodite v Chromu na `chrome://extensions/shortcuts`.
...
O: IPA oznake zahtevajo dodaten prostor. Razširitev samodejno prilagodi višino vrstice, da zmanjša vpliv na postavitev. Če še vedno moti branje, onemogočite način celotne strani in namesto tega uporabite namige ob lebdenju.

**V: Kaj pomenita simbola ~ in ≈ v namigih?**  
O: ~ pomeni, da je IPA ustvarjen s pravčilno pretvorbo (G2P), ne iz slovarja. ≈ pomeni, da je IPA izpeljan iz sorodne osnovne besede z lematizacijo. Lahko sta manj natančna kot slovarski vnosi.
