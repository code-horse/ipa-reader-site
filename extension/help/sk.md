...
- **Tipy pri najetí kurzorom** — Najetím kurzora nad anotované slová zobrazíte IPA s farebne kódovanými symbolmi a tlačidlami pre výslovnosť
...
> **Tip:** Kliknutím na ikonu rozšírenia na lište prehliadača otvoríte panel nastavení a upravíte typ prízvuku, rýchlosť prehrávania, prekladový engine a ďalšie.
...
| **Zobraziť tooltip pri najetí** | Zobrazenie IPA tipu s tlačidlom výslovnosti pri najetí kurzora |
...
Odp: Slovník IPA pokrýva bežné anglické slová. Pre slová mimo slovníka rozšírenie generuje približné IPA pomocou lematizácie a pravidlovej G2P (grafém–foném) konverzie. Označené je to ≈ alebo ~ v nápovede.
