...
IPA Reader er en nettleserutvidelse designet for engelskelever. Den legger til IPA (Det internasjonale fonetiske alfabetet) uttaleanmerkninger til engelske ord på nettsider, med støtte for både amerikansk og britisk engelsk accent, for å hjelpe deg med å lære engelsk uttale lettere.
...
- **Hover-verktøytips** — Hold musen over anmerkede ord for å se IPA med fargekodede symboler og uttaleknapper
...
> **Tips:** Klikk på utvidelsesikonet i nettleserens verktøylinje for å åpne innstillingspanelet og justere accenttype, talehastighet, oversettelsesmotor med mer.
...
| **Vis hover-verktøytips** | Vis IPA-verktøytips med uttaleknapp ved musebevegelse |
...
S: IPA-ordboka dekker vanlige engelske ord. For ord utenfor ordboka genererer utvidelsen tilnærmet IPA via lemmatisering og regelbasert G2P (grafem–fonem). Dette merkes med ≈ eller ~ i verktøytipset.
...
S: IPA-anmerkninger krever ekstra plass. Utvidelsen justerer automatisk linjehøyden for å minimere layoutpåvirkning. Hvis det fortsatt påvirker lesingen, deaktiver hele siden-modus og bruk hover-verktøytips i stedet.
